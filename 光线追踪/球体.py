...
c球体密度 = 1
@ti.func
def f光线碰撞_球体(a光线, a最小值, a最大值, a位置, a半径, a颜色, a材质):
	v相对位置 = a光线.m位置 - a位置
...
class C球体:
	def __init__(self, a位置: t向量3, a半径: float, a颜色: t向量3, a材质, a速度: t向量3 = None, a碰撞 = True):
		...
		self.m变位置 = f新建场(t向量3)
		self.m变速度 = f新建场(t向量3)
		self.m靠近门 = f新建场(int, 0)	#数字几表示靠近哪个门,0表示没有靠近任何门,在球与门计算中更新值
...
class C镜像球体:
	...
	def f光线碰撞(self, a光线, a最小值, a最大值):
		return f光线碰撞_球体(a光线, a最小值, a最大值, self.m位置[None], self.m半径, self.m物体.m颜色, self.m物体.m材质)
	@ti.func
